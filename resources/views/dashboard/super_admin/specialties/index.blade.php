                    ...
                    <div class="card-body">
                        <div class="text-end p-4 pb-0">
                            <a href="#" class="btn btn-primary d-inline-flex align-item-center" data-bs-toggle="modal"
                                ...
                                <i class="ti ti-plus f-18"></i> Add specialty
                            </a>
                        </div>
                        {{-- modal create --}}
                        @include('dashboard.super_admin.specialties.addModel')
                        {{-- end modal create --}}
                                        ...
                                        <tbody>
                                            ...
                                            @php
                                                ...
                                                @forelse ($specialties as $specialty)
                                                            ...
                                                            <ul class="list-inline me-auto mb-0">
                                                                <li class="list-inline-item align-bottom"
                                                                    ...
                                                                    <a href="#" class="avtar avtar-xs btn-link-primary"
                                                                        ...
                                                                        data-bs-target="#editModal_{{$specialty->id}}">
                                                                ...
                                                                <li class="list-inline-item align-bottom"
                                                                    ...
                                                                    <a href="#" class="avtar avtar-xs btn-link-danger"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#deleteModal_{{$specialty->id}}">
                                                    ...
                                                    @include('dashboard.super_admin.specialties.editModal', ['specialty' => $specialty])
                                                    @include('dashboard.super_admin.specialties.deleteModal', ['specialty' => $specialty])
                                                @empty
                                                @endforelse
                                            @endisset
