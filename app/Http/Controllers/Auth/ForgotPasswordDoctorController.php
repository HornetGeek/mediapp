...
use App\Mail\ResetPasswordOtpDoctorMail;
...
class ForgotPasswordDoctorController extends Controller
{
    public function sendResetCode(Request $request)
    {
        ...
        if (!Doctors::where('email', $request->email)->exists()) {
        ...
        Mail::to($request->email)
            ->send(new ResetPasswordOtpDoctorMail($otp, $doctor));
    ...
    public function resetPassword(Request $request)
    {
        ...
        DB::table('doctors')->where('email', $request->email)->update([
